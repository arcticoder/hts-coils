...
\item \textbf{High-Beta Optimization}: Computational framework achieving $\beta = 0.48$ demonstrates optimization approaches for pushing tokamak and stellarator performance beyond current limits, with direct relevance to Advanced Tokamak scenarios \cite{Plasma2023}.
